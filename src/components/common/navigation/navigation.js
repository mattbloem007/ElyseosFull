...
const NAV_ITEMS = [{name: "About Elyseos", url: "/", subItems: SUB_ITEMS_HOME}, {name: "Docs", url:"/litepaper", subItems: SUB_ITEMS_DOCS}, {name: "Elys Token", url: "/elys-token", subItems: null}, {name: "DAO", url: "/events", subItems: SUB_ITEMS_DAO}, {name: "Epochs", url:"/epochs", subItems: null},{name: "Blog", url:"/blog", subItems: null}]
